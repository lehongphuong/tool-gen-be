...
export class ApiService {
  ...
  SERVER_URL: string = 'http://localhost:1337/toolgen/Controller/SelectAllByWhat.php';
  SENTMAIL_URL: string = 'http://localhost/api/gen/Controller/SelectAllByWhat.php';
  ...
  constructor(
    ...
    this.url = 'http://localhost/api/phuong/Controller/SelectAllByWhat.php';
    this.url = 'http://localhost:8200/Controller/SelectAllByWhat.php';
  }
